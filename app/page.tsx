...
export default async function Home() {
  ...
  asChild
  size="lg"
  className="bg-[#fdfe06] hover:bg-[#e3e205] text-black font-bold px-4 sm:px-5 md:px-6 lg:px-8 py-3.5 sm:py-4 md:py-5 lg:py-6 text-sm sm:text-[15px] md:text-base lg:text-lg shadow-2xl w-full sm:w-auto"
>
